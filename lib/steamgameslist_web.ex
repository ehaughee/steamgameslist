defmodule SteamgameslistWeb do
  @moduledoc """
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: SteamgameslistWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/steamgameslist_web/templates",
        namespace: SteamgameslistWeb
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {SteamgameslistWeb.LayoutView, "live.html"}
